...
public class EtatsStock {
    ...
    public void setQuantite(double quantite) throws Exception { if (quantite >= 0) this.quantite = quantite; else throw new Exception("Quantité invalide"); }
    public void setEntree(double entree) throws Exception { if (entree >= 0) this.entree = entree; else throw new Exception("ENTREE invalide"); }
    public void setSortie(double sortie) throws Exception { if (sortie >= 0) this.sortie = sortie; else throw new Exception("SORTIE invalide"); }
    public void setReste(double reste) throws Exception { if (reste >= 0) this.reste = reste; else throw new Exception("RESTE invalide"); }
    ...
    public void setMontantEntree(double montantEntree) throws Exception { if (montantEntree >= 0) this.montantEntree = montantEntree; else throw new Exception("MONTANTENTREE invalide"); }
    public void setMontantSortie(double montantSortie) throws Exception { if (montantSortie >= 0) this.montantSortie = montantSortie; else throw new Exception("MONTANTSORTIE invalide"); }
    public void setPu(double pu) throws Exception { if (pu >= 0) this.pu = pu; else throw new Exception("PU invalide"); }
    public void setMontantReste(double montantReste) throws Exception { if (montantReste >= 0) this.montantReste = montantReste; else throw new Exception("MONTANTRESTE invalide"); }
